...
const STEP_SELECTORS = ["[data-tour='sidebar']", "[data-tour='board']", "[data-tour='info-panel']"] as const;
...
// The board is a normal-height element, so below/above works fine for it.
const STEP_SIDE_PLACEMENT: Array<"right" | "left" | null> = ["right", null, "left"];
